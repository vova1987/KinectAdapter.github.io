...
namespace Fizbin.Kinect.Gestures
{
    public class Gesture
    {
        ...
        public void UpdateGesture(Skeleton data, UserInfo UserInfo = null)
        {
            if (this.paused)
            {
            ...
            GesturePartResult result = this.gestureParts[this.currentGesturePart].CheckGesture(data, UserInfo);
        ...
        public string GestureName { get { return name; } }
